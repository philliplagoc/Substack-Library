...
- [x] **Step 3: Create `db/sync.ts` with everything except the missing pass**
...
- [x] **Step 4: Run the tests and expect the flagging ones to fail**
...
- [x] **Step 5: The `TODO(human)` — the missing pass**
...
- [x] **Step 11: Run the manual checks against a loaded build**
...
- [x] **Step 12: Update the records and commit**
