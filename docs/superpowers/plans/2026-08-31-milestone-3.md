...
- [ ] **Step 1: Add `Medium` and `Card.medium` to `domain/types.ts`**
...
- [ ] **Step 2: Write the failing tests for `parseItemMeta`**
...
- [ ] **Step 4: Create `domain/saved.ts` with everything except `parseItemMeta`**
...
- [ ] **Step 5: Add the `TODO(human)` for `parseItemMeta`**
...
- [ ] **Step 7: Pin that a card carrying `medium` restores**
